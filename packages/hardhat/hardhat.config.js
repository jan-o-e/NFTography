...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/6f083034377449a58a20c34b97392f9c", // <---- YOUR INFURA ID! (or it won't work)
    ...
    kovan: {
      url: "https://kovan.infura.io/v3/6f083034377449a58a20c34b97392f9c", // <---- YOUR INFURA ID! (or it won't work)
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/6f083034377449a58a20c34b97392f9c", // <---- YOUR INFURA ID! (or it won't work)
    ...
    goerli: {
      url: "https://https://goerli.infura.io/v3/6f083034377449a58a20c34b97392f9c.infura.io/v3/460f40a260564ac4a4f4b3fffb032dad", // <---- YOUR INFURA ID! (or it won't work)
